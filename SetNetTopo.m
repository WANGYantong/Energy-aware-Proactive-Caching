...
% Input Variable:
%         
%         opts: the input setting for the network architecture, 
%         where 0 for sparse tree topology with 23 nodes;  
%         1 for sparse tree topology with 15 nodes; 
%         2 for dense tree with 15 nodes; 
%         and default for a hetnet with 10 nodes.
%
% Output Variables:
%         
...
switch opts
    ...
    case 0
        ...
        vertice_name={'GW','EC1','EC2','EC3','EC4','EC5','EC6','EC7','EC8','EC9',...
            'EC10','EC11','EC12','EC13','EC14','R1','R2','R3','R4','R5','R6','R7','R8'};
